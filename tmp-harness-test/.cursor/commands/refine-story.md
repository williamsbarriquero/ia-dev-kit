...
3. Produza o planejamento dividido em dois papéis principais:
   - **## 🛠️ Checklist de Engenharia (Dev)**: Passos sequenciais de implementação (ex: criar contrato, implementar lógica do domínio, criar adaptadores secundários).
   - **## 🧪 Checklist de Qualidade (QA/SDET)**: Cenários Gherkin/BDD cobrindo o caminho feliz e de exceção, sugestões de casos de teste de limites e valores extremos.
