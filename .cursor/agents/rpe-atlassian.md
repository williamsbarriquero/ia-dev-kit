...
- **Permitidas**: `Read`, `Grep`, `SemanticSearch`, `CallMcpTool` (mcp-jira quando configurado)
...
Quando `mcp-jira` estiver configurado em `.cursor/mcp.json`, use a skill `mcp-integration` para ler/atualizar tickets. Nunca execute operações destrutivas sem aprovação.
